    ...
    static func addMockData(to context: ModelContext) {
       ...
       /* let existingInsigniasObtenidas = try? context.fetch(FetchDescriptor<InsigniaObtenida>())
        ...
        let eventos = [
            ...
            Evento(id: 2, fechaInicio: Date(), fechaFin: Date(), nombre: "Semana Galactica", descripcion: "dia del espacio", imagen: "https://d20ohkaloyme4g.cloudfront.net/img/document_thumbnails/a0b8d1f7b02a075564ed58d2c9a31d9d/thumb_1200_3000.png")
            ,
            Evento(id: 3, fechaInicio: Date(), fechaFin: Date(), nombre: "Semana Cosmica", descripcion: "dia del espacio", imagen: "https://d20ohkaloyme4g.cloudfront.net/img/document_thumbnails/a0b8d1f7b02a075564ed58d2c9a31d9d/thumb_1200_3000.png")
            ,
            Evento(id: 4, fechaInicio: Date(), fechaFin: Date(), nombre: "Semana Cosmica", descripcion: "dia del espacio", imagen: "https://d20ohkaloyme4g.cloudfront.net/img/document_thumbnails/a0b8d1f7b02a075564ed58d2c9a31d9d/thumb_1200_3000.png")
        ]
        ...
        let insignias = [
            Insignia(id: 1, idZona: 1, idEvento: -1, nombre: "Eco Guerrero", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por promover acciones ecológicas", completado: false, idNFC: 2),
            Insignia(id: 2, idZona: 1, idEvento: -1, nombre: "Protector del Bosque", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por proteger los recursos naturales", completado: false, idNFC: 2),
...
//            Insignia(id: 6, idZona: 1, idEvento: -1, nombre: "Guardián del Futuro", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por cuidar el planeta para futuras generaciones", completado: false, idNFC: 1),
            ...
            Insignia(id: 7, idZona: 2, idEvento: -1, nombre: "Explorador del Aire", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por realizar actividades al aire libre", completado: false, idNFC: 3),
            Insignia(id: 8, idZona: 2, idEvento: -1, nombre: "Viajero Sostenible", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por reducir el impacto ambiental durante viajes", completado: false, idNFC: 3),
...
//            Insignia(id: 11, idZona: 2, idEvento: -1, nombre: "Vigilante del Cielo", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por monitorear la calidad del aire", completado: false, idNFC: 1),
            ...
            Insignia(id: 12, idZona: 3, idEvento: -1, nombre: "Constructor Ecológico", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por construir usando materiales sostenibles", completado: false, idNFC: 4),
            Insignia(id: 13, idZona: 3, idEvento: -1, nombre: "Arquitecto Verde", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por diseñar proyectos eco-amigables", completado: false, idNFC: 4),
...
//            
            Insignia(id: 15, idZona: 4, idEvento: -1, nombre: "Guardián de los Mares", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por proteger los ecosistemas marinos", completado: false, idNFC: 5),
            Insignia(id: 16, idZona: 4, idEvento: -1, nombre: "Navegante Sostenible", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por viajar responsablemente por el océano", completado: false, idNFC: 5),
...
//            Insignia(id: 20, idZona: 4, idEvento: -1, nombre: "Cuidadores del Océano", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por iniciativas de conservación marina", completado: false, idNFC: 1),
            ...
            Insignia(id: 21, idZona: 5, idEvento: -1, nombre: "Guardianes del Hábitat", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por la preservación del hábitat natural", completado: false, idNFC: 6),
            Insignia(id: 22, idZona: 5, idEvento: -1, nombre: "Defensores de la Fauna", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por proteger especies en peligro", completado: false, idNFC: 6),
...
//            Insignia(id: 25, idZona: 5, idEvento: -1, nombre: "Embajador Ecológico", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por representar iniciativas ecológicas", completado: false, idNFC: 1),
            ...
            Insignia(id: 26, idZona: 6, idEvento: -1, nombre: "Iniciativa Verde", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por crear proyectos ecológicos comunitarios", completado: false, idNFC: 7),
            Insignia(id: 27, idZona: 6, idEvento: -1, nombre: "Voluntario Ambiental", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por participar en actividades de limpieza", completado: false, idNFC: 7),
...
//            Insignia(id: 32, idZona: 6, idEvento: -1, nombre: "Héroe de la Naturaleza", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por acciones heroicas en pro de la naturaleza", completado: false, idNFC: 1),
            Insignia(id: 33, idZona: 0, idEvento: 1, nombre: "Iniciativa Verde", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por crear proyectos ecológicos comunitarios", completado: false, idNFC: 8),
            Insignia(id: 34, idZona: 0, idEvento: 1, nombre: "Voluntario Ambiental", imagen: "https://png.pngtree.com/png-clipart/20220823/original/pngtree-green-eco-friendly-badge-design-png-image_8476472.png", descripcion: "Insignia por participar en actividades de limpieza", completado: false, idNFC: 8),
